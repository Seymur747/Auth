                ...
                <div class="dropdown">
                  <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                    ...
                    <form    action="profile.php" method="post">
                        ...
                        <button type="submit" class="alert-info" style="height: 50px ;width: 70px;text-align: center"name="exit" > Sign Out</button>
                    </form>
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    ...
                    <a class="dropdown-item" >
                        ...
                        <?php  echo "<button type='submit' class=\"dropdown-icon fe fe-log-out\" name='exit' >  Sign Out1</button>";
